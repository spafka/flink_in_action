## Overview
-list-archive.2336050.n4.nabble.com/Waterma
See [this Flink mailing list thread](http://apache-flink-user-mailingrks-with-repartition-tt5165.html). For more background on watermarks, triggers, and windows in relation to unbounded stream processing, see this excellent series: [part 1](https://www.oreilly.com/ideas/the-world-beyond-batch-streaming-101) and [part 2](https://www.oreilly.com/ideas/the-world-beyond-batch-streaming-102).
