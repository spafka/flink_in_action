...
public class QueryableWindowOperator
    ...
    private static void initializeActorSystem(String hostname) {
    ...
    @Override
    public void processElement(StreamRecord<Tuple2<String, Long>> streamRecord) {
    ...
    private static class DataInputViewAsynchronousStateHandle extends AsynchronousStateHandle<DataInputView> {
        ...
        @Override
        public StateHandle<DataInputView> materialize() {
